...
import {
  ...
  updateRecord,
  deleteRecord,
} from "@/features/slices/ourPartnersSlice";
...
const BlogFaqPage: React.FC = () => {
  ...
  const { list, loading } = useAppSelector((state) => state.ourPartners);
          ...
          <Card>
            ...
            <TableContainer
              head={[
                ...
                { key: "desktop_file", label: "Desktop Image" },
                { key: "mobile_file", label: "Mobile Image" },
              ]}
              data={rows}
