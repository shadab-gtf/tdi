...
const AboutTdi = () => {
    ...
    return (
        <section ref={sectionRef} className="relative w-full bg-[var(--color-secondary-bg)] py-32 overflow-hidden">
            ...
            <div className="relative z-10 max-w-4xl mx-auto text-center flex flex-col max-w-4xl items-center gap-6 px-6 md:px-0 ">
                <h2 className="text-xl md:text-2xl font-serif text-[var(--foreground)]">
                    Tdi City Kundli
                </h2>
                <p className="text-base text-[var(--paragraph)] font-serif leading-relaxed ">
